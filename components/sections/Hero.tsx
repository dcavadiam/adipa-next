        ...
        <section className="font-montserrat bg-linear-to-r from-primary to-secondary text-white">
            <div className="container-adipa px-4 py-16 flex items-center justify-center gap-10">
                <div className="flex flex-col items-center justify-center px-4">
                    ...
                    <p className="text-lg text-white mb-8 text-center">Mira los mejores cursos de psicología para realizar en el 2026. Recibe certificado oficial al finalizar. ¡Conoce Adipa Chile!</p>
                    <button className="bg-white text-primary px-6 py-3 rounded-full shadow-lg font-semibold text-center">Ver Cursos</button>
                </div>
